...
\label{sec:lidar}
To ensure precise operational boundary gridding and efficient path planning (as outlined in the software architecture~Fig.\ref{fig:fsm_overview}), the Courtsweeper incorporates a dedicated 2D LiDAR sensor. Based on a triangulation principle, this sensor provides robust 2D scanning of the court environment and potential obstacles.
