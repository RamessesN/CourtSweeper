...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/fig_software_overview.pdf}
...
\paragraph*{Map Generation:} Constructing a 2D occupancy grid map of the surrounding environment during the initial setup phase.

\paragraph*{Real-time Localization:} Providing continuous, high-frequency estimates of the robot's pose $(x, y, \theta)$ within the generated map by fusing LiDAR odometry and chassis wheel odometry data.
% \begin{itemize}
%   \item \textbf{} 
%   \item \textbf{} 
% \end{itemize}
